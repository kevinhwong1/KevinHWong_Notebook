...
DNA/RNA extractions for Porites Thermal Transplant Trial #1 - LARVAE

### Goal
To stream line the protocol for DNA/RNA extractions for *Porites astreoides* LARVAE for the Thermal Transplant 2018 experiment.

### Samples

Today I am using 3 larval *P. astreoides* samples that were snap frozen in the field. Each vial has 20 larvae.

**Sample Numbers: 713, 505, and 546**

### Protocol description
I used a modified version of [this protocol](https://echille.github.io/E.-Chille-Open-Lab-Notebook/Protocol-for-DNA-RNA-Extractions-of-Montipora-Coral-Larvae-Using-Zymo-Duet-Extraction-Kit/) written by [E. Chille](https://echille.github.io/E.-Chille-Open-Lab-Notebook/).
...
5. Incubate for 3.5 hours at 55 &deg;C on 1100 rpm. Check periodically to see if the samples have broken down
  * Sample 713 still had visible debris floating in the supernatant. Samples 505 and 546 were completely digested in 1 hour.
6. Centrifuge at 16,000 rcf for 30 seconds to remove debris.
7. Transfer 350 μl of the supernatant to a new, labelled 1.5 ml centrifuge tube.  
...
3. Add equal volume (to supernatant; **350 µl**) DNA/RNA lysis buffer to each sample tube  
...
> Today I had 3 samples, therefore: 225 µl of DNA Digestion buffer and 15 µl of DNase I  
...
Sample #713:
![Sample#713]({{ site.baseurl}}/images/20191205_Sample713.png "Sample#713")

Sample #505:
![Sample#505]({{ site.baseurl}}/images/20191205_Sample505.png "Sample#505")

Sample #546:
![Sample#546]({{ site.baseurl}}/images/20191205_Sample546.png "Sample#546")
...
* The digestion worked and produced good quantity and quality DNA and RNA from samples 713 and 505.
* For sample 546, the RNA quantity and quality was very good, however the DNA concentration was low and the DNA was very fragmented.
