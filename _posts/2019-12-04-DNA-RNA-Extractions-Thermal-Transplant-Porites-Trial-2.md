...
### Samples
I am using the extra supernatant from the sample bead bashed with DNA/RNA shield. Therefore I will have a direct comparison of the extra incubation digestion step. The sample numbers will be the same as 20191203, but the tubes will be labelled "B-#".
...
2. Aliquot 300 μl of sample to a new labelled tube.
3. 30 μl of Proteinase K digestion buffer (10:1 ratio of sample:digestion buffer), and 15 μl of Proteinase K (2:1 ratio of digestion buffer:Proteinase K).
4. Vortex and spin down.
5. Incubate at 56 &deg;C for 30 mins @ 600rpm
6. Centrifuge at 10,000 rcf for 30 seconds to remove debris
7. Transfer 300 μl of the supernatant to a new labelled tube
...
3. Add equal volume (to supernatant; 300 µl) DNA/RNA lysis buffer to each sample tube  
4. Finger flick to mix tubes  
5. Add 600 µl (total volume) of sample gently to the yellow DNA spin column  
...
1. Add equal volume (600 µl) 100% EtOH to the 1.5 mL tubes labeled for RNA containing the original yellow column flow through  
2. Vortex and spin down to mix  
3. Add 600 µl of that liquid to the green RNA spin columns  
4. Centrifuge at 16,000 rcf (g) for 30 seconds  
5. Discard flow through (Zymo kit waste)  
6. Add 600 µl to the green RNA spin columns (the rest from the 1.5mL RNA tubes)  
...
|     | S1     | S2       | 23   | 49   | 33   | 25   | 29   |
|-----|--------|----------|------|------|------|------|------|
| DNA | 161.89 | 21813.48 | 5.18 | 2.46 | 9.34 | 2.7  | 2.94 |
| RNA | 382.04 | 10595.29 | 22.8 | 11.8 | 16.6 | 18.0 | 32.8 |

* Initally, I started using the DNA broad range standards (as described in the [the 20191203 protocol](https://kevinhwong1.github.io/KevinHWong_Notebook/DNA-RNA-Extractions-Thermal-Transplant-Porites-Trial-1/)), however they gave readings of: S1 = 84.50 and S2 = 6972.01. Therefore I used Dr. Puritz's standards and got the values above.

### TapeStation

* Sample 33 went on the tape station but it was not read properly.

Sample #29:
![Sample#29]({{ site.baseurl}}/images/20191204_Sample29.png "Sample#29")

Sample #49:
![Sample#49]({{ site.baseurl}}/images/20191203_Sample49.png "Sample#49")

Sample #23:
![Sample#29]({{ site.baseurl}}/images/20191204_Sample23.png "Sample#23")

Sample #25:
![Sample#25]({{ site.baseurl}}/images/20191204_Sample25.png "Sample#25")

### Gel

![Gel]({{ site.baseurl}}/images/20191204_Gel.png "Gel")
